...
- **Active Trades** (top, green cards) — positions you currently own
...
- **Potential Trades** (bottom, orange cards) — saved trade ideas
...
- ✅ Auto-clear after save — calculator clears after adding to watchlist
- ✅ Expected Profit calculation — (Target - Entry) × Shares
- ✅ Long/Short indicator — 📈 LONG or 📉 SHORT badge
- ✅ Duplicate ticker check — prevents adding same stock twice
- ✅ Edit watchlist items — click any item to edit
- ✅ Edit active trades — modify actual entry, shares, notes
- ✅ Clear button only — removed Reset button
- ✅ Risk ratio validation — updates dynamically with dropdown
- ✅ Active Trades tracking — full lifecycle (potential → active → closed)
- ✅ Closed Positions section — archived trades with delete option
- ✅ Centralized storage architecture — localStorage-first updates
- ✅ Modal flow fixed — parent handles closing after state updates

---
*Session ended ~9:00 PM EST* — Activity Log updated with all PR #156 work
