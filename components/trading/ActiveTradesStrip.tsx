...
export default function ActiveTradesStrip() {
  ...
  return (
    <>
      {/* Fixed-height section — never grows to require outer scroll */}
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 min-w-0">
                        {/* Dot: green for all open trades, orange/red when near/at stop */}
                    ...
                    {/* Live price + P&L (order placed) or pending status */}
                    {trade.orderPlaced ? (
                      <div>
                        {hasPrice ? (
                          <>
