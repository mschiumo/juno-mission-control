...
interface DayTradingPerformanceProps {
  /** Trades for the selected account, already filtered by the shell. */
  trades: Trade[];
...
export default function DayTradingPerformance({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Journal Insights — journal-wide, so only meaningful on the combined view */}
      {showJournalInsights && (
