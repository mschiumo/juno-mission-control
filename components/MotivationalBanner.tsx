...
export default function MotivationalBanner({ 
  ...
  if (compact) {
    ...
    if (variant === 'orange') {
      if (loading) {
        return (
          <div className="bg-gradient-to-r from-[#ff6b35]/20 via-[#ff8c5a]/20 to-[#ff6b35]/20 border border-[#ff6b35]/30 rounded-lg p-4">
      ...
      return (
        <div className="bg-gradient-to-r from-[#ff6b35]/10 via-[#ff8c5a]/10 to-[#ff6b35]/10 border border-[#ff6b35]/30 rounded-lg p-4">
